...
<head>
    ...
    <!-- Pignose Calender -->
    <link href="../../../resources/static/plugins/pg-calendar/css/pignose.calendar.min.css" rel="stylesheet">
    <!-- Chartist -->
    <link rel="stylesheet" href="../../../resources/static/plugins/chartist/css/chartist.min.css">
    <link rel="stylesheet" href="../../../resources/static/plugins/chartist-plugin-tooltips/css/chartist-plugin-tooltip.css">
    <!-- Custom Stylesheet -->
