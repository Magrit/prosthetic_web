                            ...
                            <form:form method="post" id="step-form-horizontal"
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <div class="alert alert-danger"><spring:message code="password.confirm"/></div>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <div class=" form-check form-check-inline">
                                            <label class="form-check-label">
                                                <form:checkbox path="technician" id="tech"
                                                               cssClass="form-check-input"/>Technik</label>
                                            <label class="form-check-label">
                                                <form:checkbox path="stomatologist"
...
<script src="js/plugins-init/form-specialization.js"></script>
<!--**********************************
    Scripts
***********************************-->
